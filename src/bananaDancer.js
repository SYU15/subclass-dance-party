var BananaDancer = function(top, left, timeBetweenSteps) {
  ...
  this.$node = $('<div class="gif"><iframe src="http://giphy.com/embed/PqRbPcAt1cnHG" frameBorder="0" style="max-width: 100%" class="giphy-embed" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>');
